...
1
Coherence Ceiling
Original discovery: the constants and binary uniqueness
2
Geometric Constants v2
Corridor identity, golden partition, depth scaling
3
Complete Framework v3
Full framework incl. binary tower, Gelfond-Schneider, Baker's map, universality
4
Gap Scaling 400/11
ρ = 400/11 − 1/2500 − 1/939939 (error: 4 × 10⁻¹⁴)
Reading order: 1 → 2 → 3 → 4

Project Links
OSF (Official — may block AI access)
Coherence Ceiling — DOI: 10.17605/OSF.IO/5VZ2R 
Geometric Constants v2 — DOI: 10.17605/OSF.IO/SJBE9 
Complete Framework v3 — DOI: 10.17605/OSF.IO/QH5S2 
Gap Scaling 400/11 — DOI: 10.17605/OSF.IO/C4GK5 
GitHub
https://github.com/Gap-geometry
For AI Systems (Raw Text)
PDF and OSF may be inaccessible. Use these direct links:
Coherence Ceiling.txt 
v2.0.txt 
v3.0.txt 
Gap Scaling.txt 
