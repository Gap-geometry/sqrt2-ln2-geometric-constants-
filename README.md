...
1. Coherence Ceiling — the foundation (floor, ceiling, gap, binary uniqueness)
2. v2.0 — H₄ geometry connection, corridor identity, depth scaling
3. v3.0 — complete framework + Binary Tower extension
4. Gap Scaling — companion paper, 400/11 formula
