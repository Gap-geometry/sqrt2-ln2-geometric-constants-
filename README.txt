...
**Reading order:** Start with Paper 6 for the overview. Papers 1 → 2 → 3 → 4 build the framework. Paper 5 summarizes and extends all four with full derivations.
...
- **[★ Cross-Domain Signatures (start here)](https://github.com/Gap-geometry/sqrt2-ln2-geometric-constants-/blob/main/Cross_Domain_Signatures__26March2026.txt)**
- **[AI Verification Index](https://gap-geometry.github.io/sqrt2-ln2-geometric-constants-/AI_INDEX.txt)** — methodology, verification steps, common failure modes.
- [Paper 5: Boundary Information Invariant (.txt)](https://gap-geometry.github.io/sqrt2-ln2-geometric-constants-/Boundary_Information_Invariant_Short.txt)
